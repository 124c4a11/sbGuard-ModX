      ...
      <div class="products-upsell">
        <div class="heading-block">
          ...
          <div class="heading-block__content products-line">
            <div class="product-block circle-blob sale" data-state="-20%">
              <a href="#" class="product-block__product-image">
                <figure class="img-placeholder" data-src="assets/images/products/product1.jpg">
                  <img src="assets/images/products/product_small.jpg" alt="product" class="img-small">
                </figure>
              </a>
              <a href="#" class="product-block__product-title">HiWatch HD (1280x720)</a>
              ...
              <div class="commerce-buttons">
                ...
                <form method="get" class="product-block__fast-order-button ms2_form">
                  <button type="submit" name="ms2_action" value="cart/add" class="button only-icon-button" title="в избранное">
                    <svg class="site-icon icon-user" aria-hidden="true">
            ...
            <div class="product-block circle-blob sale" data-state="-20%">
              <a href="detail.html" class="product-block__product-image">
                <figure class="img-placeholder" data-src="assets/images/products/product2.jpg">
                  <img src="assets/images/products/product_small.jpg" alt="product" class="img-small">
                </figure>
              </a>
            ...
            <div class="product-block circle-blob hot" data-state="HOT">
              <a href="#" class="product-block__product-image">
                <figure class="img-placeholder" data-src="assets/images/products/product3.jpg">
                  <img src="assets/images/products/product_small.jpg" alt="product" class="img-small">
                </figure>
              </a>
              <a href="#" class="product-block__product-title">HiWatch HD (1280x720)</a>
            ...
            <div class="product-block circle-blob new" data-state="NEW">
              <a href="#" class="product-block__product-image">
                <figure class="img-placeholder" data-src="assets/images/products/product4.jpg">
                  <img src="assets/images/products/product_small.jpg" alt="product" class="img-small">
                </figure>
              </a>
              <a href="#" class="product-block__product-title">HiWatch HD (1280x720)</a>
